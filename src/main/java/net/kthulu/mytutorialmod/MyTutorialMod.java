...
import net.kthulu.mytutorialmod.item.ModCreativeModeTabs;
...
public class MyTutorialMod {
    ...
    public MyTutorialMod(IEventBus modEventBus, ModContainer modContainer) {
    ...
    public void onServerStarting(ServerStartingEvent event) {
        ...
        LOGGER.info("HELLO from server starting MyTutorialMod");
    }
}
